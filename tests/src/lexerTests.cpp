 ...
 */
class LexerFullTests : public testing::TestWithParam<string> {
protected:
    ParserDriver pdrv;
...
TEST_P(LexerFullTests, matchesReferenceCompiler) {
    lexInput(pdrv, lexerOutput);
    ASSERT_EQ(reference.str(), lexerOutput.str());
}
INSTANTIATE_TEST_SUITE_P(Parameterized, LexerFullTests, testing::Values(
                            "arith.cl",
                            "atoi.cl",
                            "cells.cl",
                            "hello-world.cl",
